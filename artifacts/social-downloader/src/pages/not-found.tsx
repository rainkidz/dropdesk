  ...
  return (
    <div className="mx-auto flex min-h-[calc(100dvh-72px)] max-w-[860px] items-center px-5 py-12 sm:px-10">
      <div className="max-w-xl">
        ...
        <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[hsl(var(--muted-foreground))]">404 · lost signal</p>
        ...
        <p className="mt-5 max-w-md text-base leading-7 text-[hsl(var(--muted-foreground))]">There is nothing to download here. Head back and paste a public link instead.</p>
        <Link href="/" data-testid="link-not-found-home" className="mt-8 inline-flex items-center gap-2 rounded-xl bg-[hsl(var(--primary))] px-5 py-3 text-sm font-bold text-[hsl(var(--primary-foreground))] shadow-[3px_3px_0_hsl(var(--accent))]">
          <ArrowLeft className="size-4" /> Back to downloads
        </Link>
      </div>
    </div>
  );
